...
schema.index({lead:1,createdAt:-1});schema.index({'details.newAgent':1,type:1});schema.index({actor:1,operationId:1},{unique:true,partialFilterExpression:{operationId:{$type:'string'}}});
