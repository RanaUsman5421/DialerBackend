...
const schema=new mongoose.Schema({
 ...
 latestRemark:String,lastCallBy:ref,lastCallAt:Date,lastCallOutcome:String,lastCallDirection:{type:String,enum:['OUTGOING','INCOMING']},lastCallDuration:Number,followUpAt:Date,assignedTo:{...ref,default:null},uploadedBy:{...ref,required:true},uploadedAt:{type:Date,default:Date.now},assignedBy:ref,assignedAt:Date,
